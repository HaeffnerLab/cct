...
class MULTIPOLE_CONTROL(QtGui.QWidget):
    ...
    def makeGUI(self):
        ...
        self.ctrlLayout.addWidget(self.controls['U1'],3,0)
        if self.numWells == 2:
            self.ctrlLayout.addWidget(self.controls['Ex2'],0,1)
            self.ctrlLayout.addWidget(self.controls['Ey2'],1,1)
            self.ctrlLayout.addWidget(self.controls['Ez2'],2,1)    	
            self.ctrlLayout.addWidget(self.controls['U2'],3,1)
