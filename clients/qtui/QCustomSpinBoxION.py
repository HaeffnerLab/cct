...
class QCustomSpinBoxION(QtGui.QWidget):
    onNewValues = QtCore.pyqtSignal()
    def __init__(self, levelRange, parent=None):
        QtGui.QWidget.__init__(self, parent)
        basepath = os.path.dirname(__file__)
        path = os.path.join(basepath,'notitlespin.ui')
...
if __name__=='__main__':
	...
	icon = QCustomSpinBoxION((0.0,100.0))
	icon.show()
	app.exec_()