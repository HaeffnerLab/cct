...
class ScriptControl(QtGui.QWidget):
    ...
    ExperimentInfo = {
     # ('Test', 'Exp1'):  ('clients.SCRIPT_CONTROL.experiments.Test', 'Test'),
     # ('Test', 'Exp2'):  ('clients.SCRIPT_CONTROL.experiments.Test2', 'Test2'),
     # ('Wire', 'wireVoltageModulation'): ('clients.SCRIPTCONTROL.experiments.WireVoltageModulation', 'WireVoltageModulation')
     ('Wire', 'wireVoltageModulation'): ('scripts.experiments.WireVoltageModulation', 'wireVoltageModulation'),
     ('FFT','simpleFFT'): ('scripts.experiments.FFT.FFT','simpleFFT'),
     # ('WVM', 'wvm'): ('clients.SCRIPTCONTROL.experiments.WVM', 'wvm')
     ...
     # ('WVM',):  ('scripts.experiments.WVM.wvm', 'wvm')
     }
