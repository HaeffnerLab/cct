...
class PC (QtGui.QWidget,):
    ...
    def __init__(self, reactor, parent=None):
        ...
        self.groupBox = {}
        self.groupBoxLayout = {}
#        for num, axis in list(enumerate(self.axes)):
        for axis in self.axes:
    
            self.groupBox[axis] = QtGui.QGroupBox('axis: ' + axis)
            ...
            self.control[axis + 's'].setRange (1, 10)
...
#        gridLayout.addWidget(PC(reactor, 2), 0, 1)
#        gridLayout.addWidget(PC(reactor, 3), 0, 2)
