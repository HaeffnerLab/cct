...
class ramsey_2ions_scanphase_parity(experiment):
    
    name = 'Ramsey2ions_ScanPhaseParity'
    ramsey2ions_required_parameters = [
                           ('Ramsey2ions_ScanGapParity', 'scanphase'),
    ...
    def setup_sequence_parameters(self):
        ...
        minim,maxim,steps = self.parameters.Ramsey2ions_ScanGapParity.scanphase
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('RamseyScanGap.window_name', ['Ramsey Phase Scan'])
    ...
    def run(self, cxn, context):
        ...
        for i,phi in enumerate(self.scan):
            ...
            self.dv.add([phi['deg'], parity], context = self.parity_save_context)
...
if __name__ == '__main__':
    ...
    exprt = ramsey_2ions_scanphase_parity(cxn = cxn)
