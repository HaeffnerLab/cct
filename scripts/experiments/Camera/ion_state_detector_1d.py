...
class ion_state_detector(object):
    ...
    def set_fitted_parameters(self, params, xx, yy):
        ...
        self.allions_1d = self.ion_model(params, xx, yy, use_1d=True)
    ...
    def ion_gaussians(self, params, xx, yy, use_1d=False):
        '''
        ...
        for i in range(self.ion_number):
            if use_1d:
                ...
                ion_gaussians[i] = self.gaussian_2D(xx_rotated, yy_rotated, ion_center_x + spacing * self.spacing_dict[i], 
                                                    ion_center_y, sigma, sigma, amplitude)
        return ion_gaussians
  
    def ion_model(self, params, xx, yy, use_1d=False):
        '''
...
#        sum_selected_gaussians = sum_selected_gaussians[:, None, :, :]
        ...
        #weight = self.allions_1d[None, None, :] #Is this weighting a good idea? Even noise would look like a gaussian
        a1d = np.ones_like(self.allions_1d)
        low_values_indices = self.allions_1d < 0.01  # Where values are low
...
#        ip.embed()
    ...
    def graph(self, x_axis, y_axis, image, params, result = None):
        ...
        fit_image = self.ion_model(params, xx, yy, use_1d=True)
